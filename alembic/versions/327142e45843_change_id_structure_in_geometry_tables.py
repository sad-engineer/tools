...
def upgrade() -> None:
    ...
    op.create_table('geometry_drilling_cutter',
...
def downgrade() -> None:
    ...
    op.add_column('geometry_milling_cutters', sa.Column('standard', sa.VARCHAR(length=100), autoincrement=False, nullable=True))
    op.add_column('geometry_milling_cutters', sa.Column('tool_type', sa.VARCHAR(length=100), autoincrement=False, nullable=True))
