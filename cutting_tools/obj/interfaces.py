...
class IAccuracy(CheckerInDictionary, Dictionarer):
    ...
    def __init__(self, accuracy: Union[str, int, float] = "7") -> None:
        self._accuracy = None
...
class IAccuracyClass(CheckerInDictionary, Dictionarer):
    ...
    def __init__(self, accuracy_class: Union[str, int, float] = None) -> None:
...
class INumOfBlades(Dictionarer):
    ...
    """
    def __init__(self, num_of_cutting_blades: int = 1) -> None:
...
class IRadius(Dictionarer):
    ...
    """
    def __init__(self, radius_of_cutting_vertex: float = 1) -> None:
...
class IToleranceField(CheckerInDictionary, Dictionarer):
    ...
    def __init__(self, tolerance_field: Union[str, int, float] = 'H') -> None:
...
class ITypeCutter(CheckerInDictionary, Dictionarer):
    ...
    def __init__(self, type_cutter: Union[str, int, float] = 1) -> None:
...
class ITypeOfCuttingPart(CheckerInDictionary, Dictionarer):
    ...
    def __init__(self, type_of_cutting_part: Union[str, int, float] = 1) -> None:
...
class ILargeTooth(CheckerInDictionary, Dictionarer):
    ...
    def __init__(self, large_tooth: Union[str, int, float] = 0) -> None:
...
class ICutterNumber(Dictionarer):
    ...
    """
    def __init__(self, cutter_number: Optional[str] = None) -> None:
...
class IModule(Dictionarer):
    ...
    """
    def __init__(self, module: Optional[float] = None) -> None:
        self._module = None
        self.module = module
