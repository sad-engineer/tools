...
# Типы фрез:
TYPES_OF_MILLING_CUTTER = {0: "Цилиндрическая", 1: "Торцовая", 2: "Дисковая, обработка торца",
                           3: "Дисковая, обработка паза", 4: "Отрезная и прорезная", 5: "Концевая, обработка торца",
                           6: "Концевая, обработка паза", 7: "Угловая", 8: "Фасонная, с выпуклым профилем",
                           9: "Фасонная, с вогнутым профилем", 10: "Шпоночная"}
